...
| `helloArtyTop.sv` | Earlier snapshot of the generated SV, preserved for diffing against `helloarty.sv` to show how the output evolves as the compiler matures. |
